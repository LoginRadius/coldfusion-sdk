<cfcomponent displayname="configurationapi" hint="This is the CFC for Configuration APIs">
	...
	<cffunction name="init" hint="sets up an instance of the component" output="false">
		...
		<cfargument name="lr_api_secret" required="true" hint="API secret provided by LoginRadius" 
		            type="string"/>
		<cfargument name="LR_CONFIG_API_ENDPOINT" required="false" 
		            default="https://config.lrcontent.com/ciam" 
		            hint="LoginRadius configuration api endpoint" type="string"/>
		<cfargument name="LR_SERVER_API_ENDPOINT" required="false" 
		            default="https://api.loginradius.com/identity/v2" 
		            hint="LoginRadius server api endpoint" type="string"/>
	...
	<cffunction name="getConfigurations" 
	            hint="This API is used to get the configurations which are set in the LoginRadius Dashboard.">
	...
	<cffunction name="getServerTime" 
	            hint="This API allows you to query your LoginRadius account for basic server information and server time information which is useful when generating an SOTT token.">
		<!--- Define arguments. --->
		<cfargument name="timedifference" type="string" required="false" default="10"
