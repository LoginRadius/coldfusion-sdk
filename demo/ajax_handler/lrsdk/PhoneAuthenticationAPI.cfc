<cfcomponent displayname="phoneauthenticationapi" hint="This is the CFC for Phone Authentication APIs">
...
<!---
  ...
  <cffunction name="init" hint="sets up an instance of the component" output="false">
    ...
    <cfargument name="LR_PHONE_AUTH_API_ENDPOINT" required="false" default="https://api.loginradius.com/identity/v2/auth" hint="LoginRadius phone Authentication endpoint" type="string" />
 ...
 <cffunction name="phoneForgotPasswordByOtp" hint="This API is used to send the OTP to reset the account password.">
	    <!--- Define arguments. --->
 ...
 <cffunction name="phoneResendOtpByToken" hint="This API is used to resend a verification OTP using an active token.">
	    <!--- Define arguments. --->
...
<cffunction name="registerByPhone" hint="To register user by phone">
 ...
 <cffunction name="checkPhoneNumberAvailability" hint="This API is used to check the Phone Number exists or not.">
	    <!--- Define arguments. --->
 ...
 <cffunction name="phoneNumberUpdate" hint="This API is used to update the login Phone Number of users.">
	    <!--- Define arguments. --->
	<cfargument name="accesstoken" type="string" required="true" hint="phone"/>
	<cfargument name="phone" type="string" required="true" hint="phone"/>
	<cfargument name="smstemplate" type="string" required="false" default="" hint="sms template" />
 ...
 <cffunction name="phoneVerificationByOtp" hint="This API is used to validate the verification code sent to verify a user's phone number.">
	    <!--- Define arguments. --->
	<cfargument name="phone" type="string" required="true" hint="phone"/>
 ...
 <cffunction name="phoneVerificationOtpByToken" hint="This API is used to consume the verification code sent to verify a user's phone number.">
	    <!--- Define arguments. --->
 ...
 <cffunction name="removePhoneIdByAccessToken" hint="This API is used to delete the Phone ID on a user's account via the access token.">
	    <!--- Define arguments. --->
	<cfargument name="accessToken" type="string" required="true" hint="access token"/>
	<cfargument name="payload" type="any" required="false" default="" hint ="data in json format"/>
