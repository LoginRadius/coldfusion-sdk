...
<!---
  ...
  <cffunction name="init" hint="sets up an instance of the component" output="false">
    ...
    <cfargument name="LR_ACCOUNT_API_ENDPOINT" required="false" default="https://api.loginradius.com/identity/v2/manage/account" hint="LoginRadius account api endpoint" type="string" />
	<cfargument name="LR_REGISTRATION_DATA_ENDPOINT" required="false" default="https://api.loginradius.com/identity/v2/manage" hint="LoginRadius registration data api endpoint" type="string" />
  ...
  <cffunction name="accountIdentitiesByEmail" hint="This API is used to retrieve all of the identities.">
  ...
  <cffunction name="accountImpersonationAPI" hint="This API is used to get LoginRadius access token based on UID.">
  ...
  <cffunction name="getPassword" hint="The API is used to retrieve the hashed password of a specified account.">
  ...
  <cffunction name="getProfileByEmail" hint="This API is used to retrieve all of the profile data, associated with the specified account by email.">
  ...
  <cffunction name="getProfileByUsername" hint="This API is used to retrieve all of the profile data, associated with the specified account by username.">
  ...
  <cffunction name="getProfileByPhone" hint="This API is used to retrieve all of the profile data, associated with the specified account by phone number.">
  ...
  <cffunction name="getProfileByUid" hint="This API is used to retrieve all of the profile data, associated with the specified account by UID .">
  ...
  <cffunction name="accountUpdate" hint="This API is used to update the information of existing account.">
	    <!--- Define arguments. --->
	<cfargument name="uid" type="string" required="true" />
	<cfargument name="payload" type="any" required="true" hint ="data in json format"/>
	<cfargument name="nullsupport" type="string" required="false" default="false" hint="is null support"/>
  ...
  <cffunction name="updateSecurityQuestion" hint="This API is used to update security questions configuration on an existing account.">
  ...
  <cffunction name="invalidateVerificationEmail" hint="This API is used to invalidate the Email Verification status on an account.">
	...
	<cfargument name="payload" type="any" required="false" dafault="" hint="data in json format"/>
  ...
  <cffunction name="accountDelete" hint="This API deletes the Users account and allows them to re-register for a new account.">
  ...
  <cffunction name="generateSott" hint="This API allows you to generate SOTT with a given expiration time.">

	<cfargument name="timedifference" type="string" default="10" required="false" hint="timedifference" />
	<cfif #variables.lr_api_signing# EQ "true">
			<cfset params['apikey']= "#variables.lr_api_key#">
  ...
  <cffunction name="resetPhoneIdVerification" hint="This API Allows you to reset the phone no verification of an end user�s account.">
	    <!--- Define arguments. --->
	<cfargument name="uid" type="string" required="true" />
	<cfargument name="payload" type="any" required="false" default="" hint ="data in json format"/>
	<cfif #variables.lr_api_signing# EQ "true">
  ...
  <cffunction name="mfaResetBackupCodeByUid" hint="This API is used to reset the backup codes on a given account via the uid.">
	    <!--- Define arguments. --->
	<cfargument name="uid" type="string" required="true" />
	<cfif #variables.lr_api_signing# EQ "true">
			<cfset params['apikey']= "#variables.lr_api_key#">
  ...
  <cffunction name="mfaResetGoogleAuthenticatorByUid" hint="This API resets the Google Authenticator configurations on a given account via the UID.">
	    <!--- Define arguments. --->
  ...
  <cffunction name="mfaResetSMSAuthenticatorByUid" hint="This API resets the SMS Authenticator configurations on a given account via the UID.">
	    <!--- Define arguments. --->
	<cfargument name="uid" type="string" required="true" hint="uid"/>
  ...
  <cffunction name="addRegistrationData" hint="This API allows you to fill data in dropDownList which you have created for user Registeration.">
  ...
  <cffunction name="updateRegistrationData" hint="This API allows you to update member of dropDown.">
	...
	<cfhttp method="POST" url="#variables.LR_REGISTRATION_DATA_ENDPOINT#/registrationdata/#arguments.recordid#">
	  <cfhttpparam type="header" name="Content-Type" value="application/json" />
      <cfif #variables.lr_api_signing# EQ "true">
		      <cfhttpparam type="header" name="X-Request-Expires" value="#arrayval[1]#">
		      <cfhttpparam type="header" name="digest" value="SHA-256=#arrayval[2]#">
  ...
  <cffunction name="deleteRegistrationData" hint="his API allows you to delete a member from dropDownList.">
	...
	<cfhttp method="DELETE" url="#variables.LR_REGISTRATION_DATA_ENDPOINT#/registrationdata/#arguments.recordid#">
      <cfif #variables.lr_api_signing# EQ "true">
		      <cfhttpparam type="header" name="X-Request-Expires" value="#arrayval[1]#">
		      <cfhttpparam type="header" name="digest" value="SHA-256=#arrayval[2]#">
	  <cfelse>
