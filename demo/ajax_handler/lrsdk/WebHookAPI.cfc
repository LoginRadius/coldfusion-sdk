<cfcomponent displayname="webhookapi" hint="This is the CFC for Web Hook APIs">
	...
	<cffunction name="init" hint="sets up an instance of the component" output="false">
		...
		<cfargument name="lr_api_secret" required="true" hint="API secret provided by LoginRadius" 
		            type="string"/>
		<cfargument name="LR_WEB_HOOK_API_ENDPOINT" required="false" 
		            default="http://api.loginradius.com/api/v2/webhook" 
		            hint="LoginRadius web hook api endpoint" type="string"/>
	...
	<cffunction name="webHookSubscribe" 
	            hint="API can be used to configure a WebHook on your LoginRadius site.">
	...
	<cffunction name="getWebHookSubscribedUrl" 
	            hint="This API is used to fatch all the subscribed URLs, for particular event.">
	...
	<cffunction name="webHookUnsubscribe" 
	            hint="This API can be used to unsubscribe a WebHook configured on your LoginRadius site.">
		<!--- Define arguments. --->
		<cfargument name="targeturl" type="string" required="true" hint="targeturl"/>
		<cfargument name="event" type="string" required="true" hint="event"/>
