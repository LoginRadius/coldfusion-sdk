<cfcomponent displayname="profile" hint="This is the after login api handler.">
	...
	<cfset authObject = createObject("component", "lrsdk.authenticationapi").init(lr_api_key='#LR_API_KEY#', 
	                                                                              lr_api_secret='#LR_API_SECRET#',
	                                                                              lr_api_signing='#API_REQUEST_SIGNING#')>

	<cfset accountObject = createObject("component", "lrsdk.accountapi").init(lr_api_key='#LR_API_KEY#', 
	                                                                          lr_api_secret='#LR_API_SECRET#',
	                                                                          lr_api_signing='#API_REQUEST_SIGNING#')>

	<cfset customObject = createObject("component", "lrsdk.customobjectapi").init(lr_api_key='#LR_API_KEY#', 
	                                                                              lr_api_secret='#LR_API_SECRET#',
	                                                                              lr_api_signing='#API_REQUEST_SIGNING#')>

	<cfset roleObject = createObject("component", "lrsdk.roleapi").init(lr_api_key='#LR_API_KEY#', 
	                                                                    lr_api_secret='#LR_API_SECRET#',
	                                                                    lr_api_signing='#API_REQUEST_SIGNING#')>

	<cffunction name="getProfileByUid" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="This API is used to create an account.">
	...
	<cffunction name="updateAccount" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="This API is used to create an account.">
		...
		<cfargument name="lastname" type="string" required="false" default=""
		            hint="last name"/>
		<cfargument name="about" type="string" required="false" default=""
		            hint="about"/>
	...
	<cffunction name="changePassword" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="This API is used to create an account.">
		<cfargument name="token" type="string" required="true" hint="access token"/>
		<cfargument name="oldpassword" type="string" required="false" default=""
		            hint="old password"/>
		<cfargument name="newpassword" type="string" required="false" default=""
		            hint="new password"/>
	
		<cftry>
			<cfset result = authObject.changePassword(arguments.token, arguments.oldpassword, 
	...
	<cffunction name="setPassword" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="This API is used to create an account.">
		<cfargument name="uid" type="string" required="true" hint="uid"/>
	...
	<cffunction name="createCustomObjects" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="This API is used to create an account.">
		<cfargument name="uid" type="string" required="true" hint="uid"/>
		...
		<cftry>
			<cfset result = customObject.createCustomObjectByUid(arguments.uid, arguments.objectName, 
			                                                     arguments.payload)>
			<cfif structkeyexists(result, "Uid")>
	...
	<cffunction name="getCustomObjects" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="This API is used to create an account.">
		<cfargument name="uid" type="string" required="true" hint="uid"/>
		<cfargument name="objectName" type="string" required="true" hint="object name"/>
	...
	<cffunction name="updateCustomObjects" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="This API is used to create an account.">
		<cfargument name="uid" type="string" required="true" hint="uid"/>
		<cfargument name="objectName" type="string" required="true" hint="object name"/>
		...
		<cftry>
			<cfset result = customObject.updateCustomObjectByUid(arguments.uid, arguments.objectRecordId, 
			                                                     arguments.objectName,'replace', 
			                                                     arguments.payload)>
			<cfif structkeyexists(result, "Uid")>
	...
	<cffunction name="deleteCustomObjects" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="This API is used to create an account.">
		<cfargument name="uid" type="string" required="true" hint="uid"/>
		<cfargument name="objectName" type="string" required="true" hint="object name"/>
		<cfargument name="objectRecordId" type="string" required="true" hint="object record Id"/>
		...
		<cftry>
			<cfset result = customObject.deleteCustomObjectByUid(arguments.uid, arguments.objectRecordId, 
	...
	<cffunction name="handleCreateRole" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="handle create role.">
	...
	<cffunction name="handleDeleteRole" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="handle create role.">
		<cfargument name="roles" type="string" required="true" hint="roles"/>
	...
	<cffunction name="handleAssignUserRole" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="handle create role.">
		<cfargument name="uid" type="string" required="true" hint="uid"/>
		<cfargument name="roles" type="string" required="true" hint="roles"/>
	...
	<cffunction name="getAllRoles" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="handle create role.">
		<cftry>
	...
	<cffunction name="getUserRoles" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="handle create role.">
		<cfargument name="uid" type="string" required="true" hint="uid"/>
	...
	<cffunction name="resetMultifactor" access="remote" output="true" returntype="struct"
	            returnformat="json" hint="handle create role.">
		<cfargument name="uid" type="string" required="true" hint="uid"/>
