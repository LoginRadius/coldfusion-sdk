...
var LoginRadiusSDK = (function () {
    ...
    /**The User Profile API is used to get social profile data from the userâ€™s social account after authentication. The social profile will be retrieved via oAuth and OpenID protocols. The data is normalized into LoginRadius' standard data format.
     * @function
     * @public
    ...
    /**The photo API is used to get photo data from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
    ...
    /**The Check In API is used to get check-ins data from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**The Albums API is used to get the Albums data from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**The Audio API is used to get audio files data from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**The Mention API is used to get mention data from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**The Following API is used to get the followersâ€™ information from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**The Event API is used to get the event data from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**The Post API is used to get posted messages from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**The Company API is used to get the followed companyâ€™s data in the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**The Group API is used to get group data from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**The Status API is used to get the status messages from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**The Contact API is used to get contacts/friends/connections data from the userâ€™s social account. The data will normalized into LoginRadius' data format.
     * @function
     * @public
    ...
    /**The Video API is used to get videos data from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**The Likes API is used to get likes data from the userâ€™s social account. The data will be normalized into LoginRadius' data format.
     * @function
     * @public
     * @param handle {CallbackHandler} callback handler, invoke after getting Userprofile from LoginRadius
     */
    ...
    /**This API is used to update the status on the userâ€™s wall.
     * @function
     * @public
    ...
    /**The Message API is used to post messages to the userâ€™s contacts. After using the Contact API, you can send messages to the retrieved contacts.
     * @function
     * @public
