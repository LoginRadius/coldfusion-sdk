<cfcomponent displayname="customobjectapi" 
	...
	<cffunction name="init" hint="sets up an instance of the component" output="false">
		...
		<cfargument name="LR_AUTH_CUSTOM_OBJECT_API_ENDPOINT" required="false" 
		            default="https://api.loginradius.com/identity/v2/auth" 
		            hint="LoginRadius custom object auth api endpoint" type="string"/>
		<cfargument name="LR_ACCOUNT_CUSTOM_OBJECT_API_ENDPOINT" required="false" 
		            default="https://api.loginradius.com/identity/v2/manage/account" 
		            hint="LoginRadius custom object account api endpoint" type="string"/>
	...
	<cffunction name="createCustomObjectByUid" 
	            hint="This API is used to write information in JSON format to the custom object for the specified account.">
		...
		<cfhttp method="POST" 
		        url="#variables.LR_ACCOUNT_CUSTOM_OBJECT_API_ENDPOINT#/#arguments.uid#/customobject">
	...
	<cffunction name="createCustomObjectByToken" 
	            hint="This API is used to write information in JSON format to the custom object for the specified account.">
	...
	<cffunction name="customObjectByObjectRecordIdAndUid" 
	            hint="This API is used to retrieve the Custom Object data for the specified account.">
	...
	<cffunction name="customObjectByObjectRecordIdAndToken" 
	            hint="This API is used to retrieve the Custom Object data for the specified account.">
	...
	<cffunction name="getCustomObjectByToken" 
	            hint="This API is used to retrieve the Custom Object data for the specified account.">
	...
	<cffunction name="getCustomObjectByUid" 
	            hint="This API is used to retrieve all the custom objects by UID from cloud storage.">
	...
	<cffunction name="updateCustomObjectByUid" 
	            hint="This API is used to update the specified custom object data by uid.">
		...
		<cfhttp method="PUT" 
		        url="#variables.LR_ACCOUNT_CUSTOM_OBJECT_API_ENDPOINT#/#arguments.uid#/customobject/#arguments.objectrecordid#">
			<cfhttpparam type="header" name="Accept-Encoding" value="*"/>
			<cfhttpparam type="Header" name="TE" value="deflate;q=0">
			<cfhttpparam type="header" name="Content-Type" value="application/json"/>
			<cfif #variables.lr_api_signing# EQ "true">
	...
	<cffunction name="updateCustomObjectByToken" 
	            hint="This API is used to update the specified custom object data by token.">
	
		<cfargument name="accesstoken" type="string" required="true"/>
		<cfargument name="objectrecordid" type="string" required="true"/>
		<cfargument name="objectname" type="string" required="true"/>
		<cfargument name="updatetype" type="string" required="false" default=""
		            hint="updatetype"/>
		<cfargument name="payload" type="any" required="true" hint="data in json format"/>
	
		<cfhttp method="PUT" 
		        url="#variables.LR_AUTH_CUSTOM_OBJECT_API_ENDPOINT#/customobject/#arguments.objectrecordid#">
			<cfhttpparam type="header" name="Accept-Encoding" value="*"/>
			<cfhttpparam type="Header" name="TE" value="deflate;q=0">
			<cfhttpparam type="header" name="Content-Type" value="application/json"/>
			<cfhttpparam type="header" name="Authorization" value="Bearer #arguments.accesstoken#">
	...
	<cffunction name="deleteCustomObjectByUid" 
	            hint="This API is used to remove the specified Custom Object data using ObjectRecordId of specified account.">
	...
	<cffunction name="deleteCustomObjectByToken" 
	            hint="This API is used to remove the specified Custom Object data using token of specified account.">
