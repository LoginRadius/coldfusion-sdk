<cfcomponent displayname="roleapi" hint="This is the CFC for Role Management APIs">
	...
	<cffunction name="init" hint="sets up an instance of the component" output="false">
		...
		<cfargument name="LR_ROLE_API_ENDPOINT" required="false" 
		            default="https://api.loginradius.com/identity/v2/manage" 
		            hint="LoginRadius role api endpoint" type="string"/>
	...
	<cffunction name="getContext" 
	            hint="This API Gets the contexts that have been configured and the associated roles and permissions.">
	...
	<cffunction name="rolesList" 
	            hint="This API retrieves the complete list of created roles with permissions of your app.">
	...
	<cffunction name="getRolesByUid" 
	            hint="This API is used to retrieve all the assigned roles of a particular User.">
	...
	<cffunction name="deleteContext" hint="This API Deletes the specified Role Context.">
		...
		<cfhttp method="DELETE" 
		        url="#variables.LR_ROLE_API_ENDPOINT#/account/#arguments.uid#/rolecontext/#arguments.rolecontextname#">
			<cfhttpparam type="header" name="Accept-Encoding" value="*"/>
			<cfhttpparam type="Header" name="TE" value="deflate;q=0">
			<cfhttpparam type="header" name="Content-Type" value="application/json"/>
			<cfif #variables.lr_api_signing# EQ "true">
	...
	<cffunction name="deletePermissionFromContext" 
	            hint="This API Deletes Additional Permissions from Context.">
