...
<!---
  ...
  <cffunction name="init" hint="sets up an instance of the component" output="false">
    ...
    <cfargument name="LR_SHORTEN_API_ENDPOINT" required="false" default="https://api.loginradius.com/sharing/v1" hint="LoginRadius shorten api endpoint" type="string" />
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="loginradiusTrackableStatusPosting" hint="The Trackable Status API is used to update the status on the user�s wall and return an Post ID value.">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="loginradiusSendMessagePost" hint="The Message API is used to post messages to the user�s contacts. After using the Contact API, you can send messages to the retrieved contacts">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="loginradiusGetTrackableStatusStats" hint="The Trackable Status API is used to update the status on the user�s wall and return an Post ID value.">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="loginradiusTrackableStatusFetching" hint="This API is used to retrieve a tracked post based on the passed in post ID value.">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="loginradiusShortenUrl" hint="The Shorten URL API is used to convert your URLs to the LoginRadius short URL - ish.re.">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="loginradiusGetPhotoAlbums" hint="To get the Albums data from the user's social account.">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="loginradiusStatusFetching" hint=" To get the status messages from the user's social account. The data will be normalized into LoginRadius' data format">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="getAccessTokenByPassingFacebookToken" hint="The API is used to get LoginRadius access token by sending Facebook's access token.">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="getAccessTokenByPassingTwitterToken" hint="The API is used to get LoginRadius access token by sending  Twitter's access token.">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="getAccessTokenByPassingVkontakteToken" hint="The API is used to get LoginRadius access token by sending Vkontakte's access token.">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="getAccessTokenByPassingGoogleJWT" hint="This API is used to get a LoginRadius access_token by passing in the Google JWT id_token to be used for the Google login/registration.">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="refreshUserProfile" hint="The User Profile API is used to get the latest updated social profile data from the user's social account after authentication.">
...
<cfhttpparam type="header" name="Accept-Encoding" value="*" />
  ...
  <cffunction name="refreshToken" hint="The Refresh Access Token API is used to refresh the LoginRadius Access Token or the Provider Access Token, after authentication.">
